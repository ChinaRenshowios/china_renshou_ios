...
// shareSDK
#define COCOAPODS_POD_AVAILABLE_shareSDK
#define COCOAPODS_VERSION_MAJOR_shareSDK 0
#define COCOAPODS_VERSION_MINOR_shareSDK 0
#define COCOAPODS_VERSION_PATCH_shareSDK 2
